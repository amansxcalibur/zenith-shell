...
A SOSS shell for <b>X11</b> and <b>i3wm</b>, crafted using [fabric](https://github.com/Fabric-Development/fabric). The shell features a plethera of widgets with an easily configurable and modular system. I've had a **LOT** of fun working with fabric and building this — I hope you do too!
